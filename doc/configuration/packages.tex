...
% Packages
  ...
  \usepackage[hang,small]{caption}
    ...
    % Make them smaller and with hanging indentation.
    % Possible options: hang, small, bf
...
% Settings
  ...
  % Configure the hyperref package.
    \hypersetup{
        ...
        pdftitle={Programmatic Verification of Cooking Recipes}, % title
        pdfauthor={Konstantin Weitz, Tobias Stöckel},     % author
        pdfsubject={Programmatic verification of cooking recipes using Allen Logic and LISP},
        pdfcreator={Konstantin Weitz, Tobias Stöckel},    % creator of the document
        pdfproducer={Konstantin Weitz, Tobias Stöckel},   % producer of the document
