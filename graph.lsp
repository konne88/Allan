...
(let ((a '((1 . 2) (2 . 3) (3 . 4) (4 . 5) (5 . 1)))
      ...
      (nodes '(1 2 3 4 5)))
  (print (if 
    (and (equal (sort (remove-duplicates (find-nodes b)) '<) nodes)
...
;(print (length (find-cycles '((1 . 2) (2 . 3) (3 . 4) (4 . 1) (1 . 3) (2 . 4) (5 . 1) (5 . 2) (5 . 3) (5 . 4))))) 

;(print (length (find-cycles '((1 . 2) (2 . 3) (3 . 4) (4 . 1) (1 . 3) (2 . 4) (5 . 1) (5 . 2) (5 . 3) (5 . 4) (6 . 1) (6 . 2) (6 . 3) (6 . 4) (6 . 5))))) 
